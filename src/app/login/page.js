        ...
        <div className="lg:w-[39%] w-full bg-white overflow-y-auto h-screen lg:rounded-r-[28px] px-6 flex justify-center items-center">
          <div className="sm:w-[360px] w-full py-8">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[19px] font-medium text-gray-500">Log in</span>
            </div>
            <div className="mt-4">
              <div className="pt-5">
              ...
              <div onClick={() => router.push('/forgotPassword')} className="flex justify-end text-sm font-medium text-gray-700 my-4 cursor-pointer hover:opacity-80 transition ease-in-out duration-300">
                Forgot password?
              </div>
              <div>
                <button
                  className={`${buttonClass} ${loadingAnimation ? 'cursor-default opacity-60 pointer-events-none' : ''} w-full rounded-full flex justify-center items-center text-sm h-[38px] shadow`}
                  type="submit"
                >
                  {loadingAnimation ? (
...
<button
  ...
  className="w-full rounded-full flex justify-center items-center gap-2 hover:bg-gray-100 transition ease-in-out duration-150 text-sm h-[41px]"
...
>
            ...
            <div className="text-gray-600 text-sm flex gap-1 mt-4 justify-center">
              ...
              <span className="font-medium hover:opacity-80 transition ease-in-out duration-300 cursor-pointer" onClick={() => router.push('/register')}>
                Sign up
              </span>
            </div>
          </div>
